...
console.log(filterDateForGraf(new Date()))
    ...
    function sumTwoDate(date){
      var firstDayData = detailEvn(date);
      var secondDayData = detailEvn(new Date(date.setHours(date.getHours()-24)));
      return secondDayData.concat(firstDayData) 
    }
